// ТУДУ: Функція з маленької літери крім декораторів
// body повинно бути максимально типізоване, щоб ти розумів точно який формат може там бути
...
//   }
// }
// Альтернатива. Також круто використовувати в таких випадках типи
// interface TelegramMessageWebhookType = {
//   body: {
//     ...types
//   }
// }
// interface TelegramDocumentWebhookType = {
//   body: {
//     ...types
//   }
// }
//  type TelegramWebhook = TelegramMessageWebhookType | TelegramDocumentWebhookType
//  В таких випадках ти будеш точніше розуміти які поля точно є, 
//   а яких не має, що зробить подальшу роботу простішою
...
async function TelegramWebhook({ body }) {
  ...
  // ТУДУ: заміни світч на окремі блоки. Вкладений світч погано читаєтьсья
  //  приклад   
  // if (body.message) {
  //   const parsedBody = parseTelegramBodyMessage(body)
  //   return parsedBody;
  // }
  // if (body.callback_query) {
  //   const parsedCallBackQuery = parseTelegramCallbackQuery(body)
